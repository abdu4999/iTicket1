    ...
    if (isset($_POST['login'])) {
      ...
      if (isset($username)) {
        ...
        if (strlen($filterdUser) < 4) {
          $formErrors[] = 'Useraname Must Be Laarger Than 4 Characters';
        }
      }
      ...
      // check if there's no error peoceed the user add
      ...
      if (empty($formErrors)) {
        ...
        if ($check == 1) {
          ...
          // echo success maessages

          $succesMsg = 'Congrats You Are Now Registerd';
...
?>
  ...
  <div class="container login-page">
    ...
    <form class="signup" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" >
      <div class="input-container">
        <input pattern=".{4,}" title="Username Must Be 4 Characters" class="form-control" type="text" name="username"
